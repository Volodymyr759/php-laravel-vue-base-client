...
export default defineComponent({
  props: {
    property: {
      type: Object as PropType<IDashboardPropertyItem>,
      required: true,
    },
  },
  components: {
