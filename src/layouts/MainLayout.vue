      ...
      <div class="content-wrapper">
        ...
        <div>
          ...
          >
            ...
            <Paragraph className="gray80-p-18">
              Definitions
            </Paragraph>
            <ul style="margin-left: 25px">
              <li>
                <Span className="gray80-span-bold-16">Account</Span>
                <Span className="gray80-span-16"> means a unique account created for You to access our Service or parts of our Service.</Span>
              </li>
              <li>
                <Span className="gray80-span-bold-16">Country</Span>
                <Span className="gray80-span-16"> refers to: NYC, United States.</Span>
              </li>
              <li>
                <Span className="gray80-span-bold-16">Company</Span>
                <Span className="gray80-span-16"> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement).</Span>
              </li>
              <li>
                <Span className="gray80-span-bold-16">Device</Span>
                <Span className="gray80-span-16"> means any device that can access the Service such as a computer, a cellphone or a digital tablet.</Span>
              </li>
              <li>
                <Span className="gray80-span-bold-16">Feedback</Span>
                <Span className="gray80-span-16"> means feedback, innovations or suggestions sent by You regarding the attributes, performance or features of our Service.</Span>
              </li>
            </ul>
          </a-modal>
        </div>
        ...
        <div>
          ...
          >
            ...
            <Paragraph className="gray80-p-16">
              Essentially, your terms and conditions text is a contract between your website and its users. In the event of a legal dispute, 
              arbitrators will look at it to determine whether each party acted within their rights.
            </Paragraph>
            <Paragraph className="gray80-p-bold-18">
              Interpretation and Definitions
            </Paragraph>
        ...
        <footer
          class="flex-row flex-space-between"
          style="padding: 0 40px; background: linear-gradient(0deg, rgba(7, 31, 55, 0.05), rgba(7, 31, 55, 0.05)), #ffffff;box-shadow: 0px 0px 5px rgba(26, 39, 37, 0.05);"
        >
          <div>
            <Span className="gray80-span-12">© 2022 PropTech - All Rights Reserved.</Span>
          </div>
          <div>
            <Span className="gray80-span-12" style="cursor: pointer" @click="modalPrivacyPolicyVisible = true">Privacy Policy</Span>
            |
            <Span className="gray80-span-12" style="cursor: pointer" @click="modalTermsOfServiceVisible = true">Terms of Service</Span>
          </div>
        </footer>
      </div>
    </section>
