<template>
  ...
  >
    <div>
      <div v-if="property.images.length > 0" class="text-align-center">
        <img :src="require('C:/Users/user/source/repos/php-laravel-vue-base/storage/app/public/images/' + 
          property.images[0].name)" alt="property photo" class="property-photo"/>
      </div>
      <div v-else class="text-align-center">
        <img src="/images/no_property_photo.png" alt="property photo" class="property-photo"/>
      </div>
      <br />
      <img src="/images/geo_pin.svg" alt="geo icon" />
      <Span className="gray80-span-12">{{property.address}}</Span>
      <br />
      <a-row class="property-status-row">
        <a-col :span="8">
        ...
        <a-col :span="8" :offset="8" class="text-align-right">
          ...
          <span>
            <a-tooltip placement="topLeft" :title="'Edit Property: ' + property.address" arrow-point-at-center>
              <a @click="onEdit(property)">
                <a-space>
                  <img src="/images/edit.svg" alt="edit" class="action-icon"/>
                </a-space>
              </a>
            </a-tooltip>
            ...
            <a-tooltip placement="topLeft" title="Upload Photos" arrow-point-at-center>
              <a @click="onUploadPhotos(property.id)">
                <a-space>
                  <img src="/images/sign_in_squre.svg" alt="sign_in_squre" class="action-icon"/>
                </a-space>
              </a>
            </a-tooltip>
            <a-divider type="vertical" />
            <a-tooltip placement="topLeft" title="Delete" arrow-point-at-center>
              <a @click="onDelete(property.id)">
                <a-space>
                  <img src="/images/delete.svg" alt="delete" class="action-icon"/>
                </a-space>
              </a>
            </a-tooltip>
          </span>
      ...
      <a-row>
        ...
        <a-col :span="7" :offset="7" class="text-align-right">
...
export default defineComponent({
  ...
  setup(props, { emit }) {
    const properties = computed<IProperty[]>(
    ...
    function onDelete(id: number): void {
      Modal.confirm({
        ...
        content: createVNode(
          "div",
          { style: "color:red;" },
          "The property will be removed immediately."
        ),
        onOk() {
