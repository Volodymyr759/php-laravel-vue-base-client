        ...
        <a-table :columns="columns" :data-source="data" :pagination="pagination">
          <template #bodyCell="{ column, record }">
            ...
            <template v-else-if="column.key === 'status'">
              ...
              <div v-else-if="record.status === 'Updated'" class="text-align-center">
                <img src="/images/orange_circle.svg" alt="orange circle" class="circle-item"/>{{record.status}}
              </div>
            ...
            <template v-else-if="column.key === 'report'">
              <div class="chat" @click="handleReport(record.key)">
...
export default defineComponent({
  ...
  setup() {
    ...
    const handleChangeReportStatus = (value: string) => {
      console.log(`selected report status: ${value}`);
    };
    ...
    return {
      ...
      handleReport: (id: string) =>
        alert(`Report button has been clicked, id: ${id}`),
      showAlert: () => {
        alert("Add Report button is not implemented yet");
      },
    };
  },
});
