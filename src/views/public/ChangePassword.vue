...
export default defineComponent({
 components: { Button, Paragraph, Span },
  setup() {
    const changePasswordDto = reactive<IChangePasswordDto>({ oldPassword: "", newPassword: "", passwordConfirm: "" });
    const onSubmit = async (changePasswordData: IChangePasswordDto) => store.dispatch("auth/changePassword", changePasswordData);
